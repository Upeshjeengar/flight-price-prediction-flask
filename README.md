...
![img](https://github.com/Upeshjeengar/flight-price-prediction-flask/blob/master/data/Screenshot%20(168).png)
![img](https://github.com/Upeshjeengar/flight-price-prediction-flask/blob/master/data/Screenshot%20(170).png)
...
```
```bash
# In the main function of app.py make below mentioned changes
